...
listOfScans = ['Quick1']#, 'Dog_1', 'Dog_2', 'Dog_3', 'Dog_4', 'Dog_5', 'Patient_1', 'Patient_2']
...
def main():
  ...
  print eT.finalPredict(name, directory, listOfScans, transforms.HillTFWTFC, clf2, fiveSplit = True)
